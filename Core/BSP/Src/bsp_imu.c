...
#define BMI_ACCEL_NSS_LOW	HAL_GPIO_WritePin(ACC_CS_GPIO_Port, ACC_CS_Pin, GPIO_PIN_RESET)
#define BMI_ACCEL_NSS_HIGH	HAL_GPIO_WritePin(ACC_CS_GPIO_Port, ACC_CS_Pin, GPIO_PIN_SET)
#define BMI_GYRO_NSS_LOW	HAL_GPIO_WritePin(GYRO_CS_GPIO_Port, GYRO_CS_Pin, GPIO_PIN_RESET)
#define BMI_GYRO_NSS_HIGH	HAL_GPIO_WritePin(GYRO_CS_GPIO_Port, GPIO_PIN_3, GPIO_PIN_SET)
