...
void can_ISR(FDCAN_HandleTypeDef *hcan);
 ...
 *                      must be 8 bytes.
 */
HAL_StatusTypeDef can1_get_msg(FDCAN_HandleTypeDef *hcan, FDCAN_RxHeaderTypeDef *rx_msg_header, uint8_t *rx_buffer);
HAL_StatusTypeDef can2_get_msg(FDCAN_HandleTypeDef *hcan, FDCAN_RxHeaderTypeDef *rx_msg_header, uint8_t *rx_buffer);
/**
 ...
 */
uint32_t can_send_msg(FDCAN_HandleTypeDef *hcan, uint32_t id, uint8_t* data );
 ...
 */
void can_start(FDCAN_HandleTypeDef *hcan, uint32_t CAN_filterID, uint32_t CAN_filterMask);
